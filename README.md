...
A comprehensive command-line tool for analyzing password strength and generating secure passwords. Slovo provides advanced password security analysis including pattern detection, repetition analysis, dictionary word checking, crack time estimation, policy validation, and batch processing.
